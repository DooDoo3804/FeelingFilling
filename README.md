...
> [3. 서비스 화면](#3-서비스-화면)
>
> > - [3-1. 회원가입 및 결제등록 화면](#3-1-회원가입-및-결제등록-화면)
> > - [3-2. 로그인 화면](#3-2-로그인-화면)
> > - [3-3. 홈 화면](#3-3-홈-화면)
...
<img src="./docs/img/capture/signup.gif">

- ### 3-2. 로그인 화면

<img src="./docs/img/capture/login.gif">

- ### 3-3. 홈 화면

<img src="./docs/img/capture/home.gif">

- ### 3-4. 메인 채팅창 : 텍스트 전송 및 분석요청

<img src="./docs/img/capture/textInput.gif">

- ### 3-5. 메인 채팅창 : 음성 전송 및 분석요청

<img src="./docs/img/capture/audioInput.gif">

- ### 3-6. 개인별 맞춤 통계 제공

<img src="./docs/img/capture/personalStat.gif">

- ### 3-7. 상세 내역을 월별 조회

<img src="./docs/img/capture/savingList.gif">

- ### 3-8. 전체 사용자들의 저금 추이, 이달의 저금왕 조회

<img src="./docs/img/capture/allStat.gif">

- ### 3-9. 마이페이지, 뱃지 관련 기능

<img src="./docs/img/capture/mypage.gif">
