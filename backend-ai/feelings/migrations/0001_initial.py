# Generated by Django 3.2.13 on 2023-04-26 06:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('achieveddate', models.DateTimeField(blank=True, db_column='achievedDate', null=True)),
                ('badgeid', models.IntegerField(db_column='badgeId')),
                ('user_userid', models.CharField(blank=True, db_column='user_userId', max_length=255, null=True)),
            ],
            options={
                'db_table': 'Badge',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('react', models.CharField(blank=True, max_length=255, null=True)),
                ('requesttime', models.DateTimeField(blank=True, db_column='requestTime', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_oauth2', models.CharField(blank=True, max_length=255, null=True)),
